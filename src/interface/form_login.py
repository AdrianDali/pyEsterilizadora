...
class App: 
    ...
    def __init__(self): 
        ...
        frame_form = tk.Frame(self.ventana, bd = 0 , relief=tk.SOLID, bg = "#3ff3f5")
        ...
        #titulo 
        title = tk.Label(frame_form_top , text = "Inicio de sesion", font = ('Times', 30 ), bg = "#fcfcfc", fg = "#666a88", pady = 50)
        #que se expanda 
        title.pack(expand= tk.YES, fill = tk.BOTH)

        #frame de relleno para el formulareio 
        frame_from_fill = tk.Frame(frame_form,height  = 50 , bd = 0 , relief = tk.SOLID , bg = "red")
        frame_from_fill.pack(side= "bottom", expand = tk.YES, fill = tk.BOTH)
       
        etiqueta_usuario = tk.Label(frame_from_fill, text = "Usuario", font = ('Times', 14 ), bg = "#fcfcfc", fg = "#666a88", anchor = "w" )
        etiqueta_usuario.pack(fill= tk.X ,padx =20 , pady = 5)
        self.usuario = ttk.Entry(frame_from_fill, font=('Times', 14 ))
        self.usuario.pack(fill= tk.X ,padx =20 , pady = 10)

        etiqueta_password = tk.Label(frame_from_fill, text = "Contrasena", font = ('Times', 14 ), bg = "#fcfcfc", fg = "#666a88", anchor = "w" )
